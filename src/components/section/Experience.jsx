...
export default function Experience() {
  ...
  return (
    <motion.div
      id="experience"
      className="w-full flex flex-col justify-center items-center text-center bg-[#151817] p-10"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 1 }}
    >
      <motion.p
        className="text-[#5BA97D] text-center lg:text-6xl sm:text-4xl"
      ...
      <motion.p
        className="leads text-[#FDFDFD] lg:text-6xl sm:text-4xl mt-2.5 lg:mb-10 sm:mb-5"
        initial={{ y: -50, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
